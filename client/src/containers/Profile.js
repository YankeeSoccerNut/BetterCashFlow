...
// Intention is to use this page to allow profile changes.  It is similar to register and allows UPDATES to current user...backend will use uid, pwd and token to authenticate before changes occur....

// TODO: add new pwd, retype new pwd fields
